...
## Ejercicio 5
Si todos los servidores deben autenticarse entre sí, todos deben tener instalada la clave pública de la CA que firmó los certificados de las CA intermedias que son las que firmaron los certificados de los servidores en cuestión. Los certificados deben estar instalados localmente según corresponda (según quién sea) y lo que se debe tener almacenado sí o sí es la clave pública de la CA Root. Esto permitirá, al momento del handshake SSL/TLS, en este caso, obligatorio, que se presente el certificado por parte del cliente para que el servidor con la pública del Root pueda constatar que se trata de quién decimos ser (que nuestra pública es nuestra), para luego negociar los algoritmos y cifrar la comunicación. Además, del lado del cliente, el servidor manda, en la fase 1, el certificado, y como el cliente tiene la pública de Root puede chequear que se está conectando a un servidor no-malicioso. 